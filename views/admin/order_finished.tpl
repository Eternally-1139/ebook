            ...
            <div class="ibox-content">
                <table class="table table-striped table-bordered table-hover dataTables-example">
                    ...
                    <tr class="gradeX">
                        ...
                        <th>地址代码</th>
                        <th>{{.OddNumber}}</th>
                        <td class="center" style="text-align: center"><button class="btn btn-success btn-sm" onclick="openShowDriver({{.Id}});"><i class="fa fa-eye"></i> 查看物流</button></td>
                        <td class="center" style="text-align: center"><button class="btn btn-default btn-sm" onclick="changeDriver({{.Id}});"><i class="fa fa-eye"></i> 修改物流单号</button></td>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="changeDriverSubmit();">提交</button>
            </div>
        </div>
    </div>
</div>
        ...
        $.ajax({
            ...
            success: function(data) {
                if(data.status==10000){
                    window.location.href="/admin/order_finished";
